...
> Existe uma janela de arbitragem de **~90%** em pagamentos cross-border via stablecoin — e ela tem **data de expiração regulatória** (Resolução BCB 561, out/2026). Este projeto mede os três lados dessa decisão ao mesmo tempo: **quanto se economiza**, **quanto risco se corre**, e **quanto custa o caixa parado**.
